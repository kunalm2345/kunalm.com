...
<div class="min-h-screen">
	...
	<div class="md:relative md:p-none px-6">
		<div class="max-w-screen-md mx-auto my-24">
			<!-- Header with photo and social icons -->
			<header class="flex items-start justify-between mb-12">
				...
				<nav class="list-none">
					<ul class="flex gap-4 items-center">
						<li class="list-none">
							<a href="http://x.com/knlmsh/" target="_blank" rel="noopener noreferrer" aria-label="Twitter" class="social-icon">
						...
						<li class="list-none">
							<a href="http://github.com/kunalm2345/" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="social-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3">
						...
						<li class="list-none">
							<a href="http://instagr.am/knlmsh/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="social-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3">
						...
						<li class="list-none">
							<a href="https://www.linkedin.com/in/kunal-mishra-8238bb187/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="social-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3">
						...
						<li class="list-none">
							<a href="mailto:kunalm@duck.com" aria-label="Email" class="social-icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3">
				...
				<BentoGrid>
					...
					{#if isVisible('Research')}
						<CardStack 
							...
							content="Building a hi-precision indoor positioning system using WiFi (and other sensors) as a replacement for GPS. Supported by gradCapital and SIRE."
							date="Now"
							size="1x1"
							tag="Research"
							type="work"
					...
					{/if}
					<CardStack 
						title="Marketing at CEL"
						content="Heading Marketing for CEL, short for Center for Entrepreneurial Leadership. We help students on campus build startups."
						date="Now"
						size="1x1"
						type="work"
					/>
					...
					{#if isVisible('Research')}
						<CardStack 
							...
							content="A paper I'm working on under Prof Sougata Sen where we're trying to train a model on CSI value plots of a WIFi network in a room to recognise what's going on between the sender and receiver."
							href="https://sougata-sen.com/"
							linkText="VISIT"
							date="2025"
							size="1x1"
							tag="Research"
					...
					{#if isVisible('Research')}
						<CardStack 
							title="Smart Space"
							content="The research project I'm leading at DaSH lab, BITS Goa where we're putting raspberry pis and cameras in a classroom to monitor student attention to help improve teaching pedagogy."
							date="2025"
							size="1x1"
							tag="Research"
							type="project"
					...
					{#if isVisible('Web Dev')}
						<CardStack 
							...
							content="I'm leading a team building a webportal for SEDS Celestia, our college astronomy club's motorised telescope, so anybody could request a live image from it of the night sky."
							date="2025"
							size="1x1"
							tag="Web Dev"
							type="project"
					...
					{#if isVisible('Web Dev')}
						<CardStack 
							title="Socialscri.be"
							content="Socialscribe lets newsletter creators add social sign-up buttons (sign-up with google) to their websites without coding. I designed and built the entire thing up and grew it to over $1k in profits."
					...
					{#if isVisible('Web Dev')}
						<CardStack 
							...
							content="Did full stack web-dev at Buttondown — I built a few features with Django and Vue.js. I've been generally interested in the email industry. It was a dream working with Justin."
							date="2024"
							size="1x1"
							tag="Web Dev"
							type="work"
					...
					{#if isVisible('Web Dev')}
						<CardStack 
							title="ServiceSetu Portal"
							content="Built a jobs and announcements portal for ServiceSetu — I built a website for a higher ed job portal that a PhD at my college is running with her husband. They have a large following and routinely get 45-60k views a month."
							date="2024"
							size="1x1"
							tag="Web Dev"
							type="work"
					...
					{#if isVisible('Research')}
						<CardStack 
							title="Smart Classroom at DaSH Lab"
							content="Built a smart classroom at DaSH Lab – I worked under Prof Arnab Paul to build a smart classroom environment that monitors student attention to help improve teaching pedagogy."
							date="2024"
							size="1x1"
							tag="Research"
							type="work"
