...
export const workPage = writable(`
    

<h1 class="font-serif text-6xl mb-2">Work Experience</h1>
<p class="text-2xl">
...
<p class="text-2xl"><br>Previously: <br><br> </p>
<ul class="text-2xl list-inside no-underline">
   
    <li><b>SEO Lead at HelloMeets</b> — I handled the entire publishing process for the HelloMeets blog while growing it from 600 to over 45k visits a month, in 8 months on a strict budget.
    </li> <br>
