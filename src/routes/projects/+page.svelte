...
<ul class="text-2xl list-inside">
    ...
    <li><b>Dump.ink</b> – Dump is a minimal micro-blogging platform I built for Deta Space which lets anybody create and host their own microblogs for free for ever. It is completely decentralised. Deta offered to buy it from me if I turned it into a decentralised social media protocol which I couldn't work on as life got in the way. I may continue this in the future.    </li>
    <br>

    <li><b>Back of my Head (now defunct)</b> – I ran an email newsletter rounding up cool stuff I found throughout the week. It went on the get over a thousand subscribers but I couldn't be consistent and decided to drop it.
    </li>
    <br>
